    ...
    <div>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-20">
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="border-[3px] p-6 md:p-10 flex flex-col items-center text-center">
            <div className="flex items-center md:flex-col md:items-center mb-4 md:mb-6 w-full md:w-auto">
              <ArrowUpTrayIcon className="w-12 h-12 md:w-16 md:h-16 text-primary mr-4 md:mr-0 md:mb-6 flex-shrink-0" strokeWidth={2.5} strokeLinecap="square" strokeLinejoin="miter" />
              <h2 className="text-xl md:text-2xl font-bold text-foreground">{t('home.uploadTitle')}</h2>
            </div>
          ...
          <Card className="border-[3px] p-6 md:p-10 flex flex-col items-center text-center">
            <div className="flex items-center md:flex-col md:items-center mb-4 md:mb-6 w-full md:w-auto">
              <ArrowDownTrayIcon className="w-12 h-12 md:w-16 md:h-16 text-foreground mr-4 md:mr-0 md:mb-6 flex-shrink-0" strokeWidth={2.5} strokeLinecap="square" strokeLinejoin="miter" />
              <h2 className="text-xl md:text-2xl font-bold text-foreground">{t('home.downloadTitle')}</h2>
            </div>
            <p className="text-muted-foreground mb-6 md:mb-8 text-sm md:text-base">
                  ...
                  <button
                    ...
                    className={`absolute right-[5.5px] md:right-[7.5px] top-1/2 -translate-y-1/2 p-2 rounded-lg transition-colors ${
                      downloadCode.length === 6
                        ? 'bg-primary text-primary-foreground can-hover:hover:bg-primary/90 active:bg-primary/90'
