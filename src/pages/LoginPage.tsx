                    ...
                    <CardContent className="p-0">
                        ...
                        <div className="space-y-4 mb-8">
                            <button
                                ...
                                className="w-full relative flex items-center justify-center px-6 py-3 bg-[#F2F2F2] dark:bg-[#131314] border border-border rounded-lg can-hover:hover:bg-[#E8E8E8] dark:can-hover:hover:bg-[#1f1f1f] transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="w-full relative flex items-center justify-center px-6 py-3 bg-[#03C75A] can-hover:hover:bg-[#02b350] rounded-lg transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="w-full relative flex items-center justify-center px-6 py-3 bg-[#FEE500] can-hover:hover:bg-[#f0d900] rounded-lg transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="w-full relative flex items-center justify-center px-6 py-3 bg-black dark:bg-white rounded-lg can-hover:hover:bg-[#333333] dark:can-hover:hover:bg-[#e8e8e8] text-white dark:text-black transition-colors"
                            >
                        ...
                        <div className="text-center text-xs text-muted-foreground/70 leading-relaxed">
                            {t('login.termsNotice')}
                            <a href="/privacy-policy" className="text-muted-foreground underline can-hover:hover:text-foreground">
                                {t('footer.privacyPolicy')}
                            </a>
                            {t('login.termsAnd')}
                            <a href="/terms-of-use" className="text-muted-foreground underline can-hover:hover:text-foreground">
                                {t('footer.termsOfUse')}
                            </a>
                            {t('login.termsAgree')}
                        </div>
