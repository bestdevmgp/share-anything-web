...
const RecentLoginBubble: React.FC<{ label: string }> = ({ label }) => (
    <span className="absolute left-full top-1/2 -translate-y-1/2 ml-[10px] opacity-0 [animation-delay:500ms] animate-bubble-pop pointer-events-none inline-flex items-center bg-popover border border-border rounded shadow-md px-[7px] py-[8px]">
