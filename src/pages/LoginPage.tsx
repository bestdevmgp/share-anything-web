                ...
                <div className="bg-white dark:bg-[#0B0A0B] rounded-3xl border-2 border-gray-200 dark:border-white/10 p-10">
                    ...
                    <div className="space-y-4 mb-8">
                        <button
                            ...
                            className="w-full relative flex items-center justify-center px-6 py-3 bg-white dark:bg-[#1A1A1A] border border-gray-300 dark:border-white/15 rounded-lg hover:bg-gray-50 dark:hover:bg-white/10 transition-colors"
                        >
