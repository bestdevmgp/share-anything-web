                  ...
                  personalTokens.map((key) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        className="text-red-600 dark:text-red-400 can-hover:hover:text-red-600 dark:can-hover:hover:text-red-400 can-hover:hover:bg-red-100/50 dark:can-hover:hover:bg-red-100/500/15 flex-shrink-0"
                      >
