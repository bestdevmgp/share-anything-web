          ...
          <div className="relative">
            <div className="absolute top-1/2 -translate-y-1/2 right-3 flex gap-1 z-10">
              ...
              <Button
                ...
                className="text-muted-foreground can-hover:hover:text-red-600 dark:can-hover:hover:text-red-400 [&_svg]:h-5 [&_svg]:w-5"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={cn('border-t border-border p-4 bg-background', closingRow === upload.id ? 'animate-collapse-up' : 'animate-expand-down')}>
              <div className="space-y-4">
                <div>
                  ...
                  <div
                    className={cn(
                      'bg-card rounded-lg border border-border overflow-hidden cursor-pointer can-hover:hover:border-primary/50 transition-colors',
