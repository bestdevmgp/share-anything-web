        ...
        <div className="flex items-center justify-between mt-1">
          ...
          {uploads.length > 0 && (
            <Button
              ...
              className="text-red-600 dark:text-[#f25f5f] can-hover:hover:bg-red-50 can-hover:hover:text-red-600 dark:can-hover:hover:bg-red-500/10 dark:can-hover:hover:text-[#f25f5f] active:bg-red-50 active:text-red-600 dark:active:bg-red-500/10 dark:active:text-[#f25f5f] -mr-3"
            >
              {t('history.deleteAll')}
            </Button>
          )}
