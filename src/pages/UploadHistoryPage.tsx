        ...
        <div className="flex items-center justify-between mt-1">
          ...
          {uploads.length > 0 && (
            <Button
              ...
              className="text-red-600 dark:text-red-400 can-hover:hover:bg-red-50 can-hover:hover:text-red-600 dark:can-hover:hover:bg-red-500/15 dark:can-hover:hover:text-red-400 active:bg-red-50 active:text-red-600 dark:active:bg-red-500/15 dark:active:text-red-400 -mr-3"
            >
              {t('history.deleteAll')}
            </Button>
          )}
