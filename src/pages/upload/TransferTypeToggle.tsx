          ...
          >
            ...
            <div className="border-t border-border pt-3 px-1 flex items-center justify-between">
              <button
                ...
                className="text-xs text-muted-foreground/60 can-hover:hover:text-muted-foreground active:text-muted-foreground underline underline-offset-2 transition-colors"
              >
