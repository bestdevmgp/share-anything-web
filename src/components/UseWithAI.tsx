...
const MarkdownIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5 shrink-0 text-foreground/70" fill="currentColor" aria-hidden="true">
...
const ClaudeIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5 shrink-0" fill="#D97757" aria-hidden="true">
...
// OpenAI / ChatGPT mark.
const ChatGptIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5 shrink-0 text-foreground/80" fill="currentColor" aria-hidden="true">
