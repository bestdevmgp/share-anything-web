                ...
                >
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg transition-colors text-muted-foreground/50 can-hover:hover:text-red-600 dark:can-hover:hover:text-red-400 can-hover:hover:bg-red-100 dark:can-hover:hover:bg-red-1000/15 active:text-red-600 dark:active:text-red-400 active:bg-red-100 dark:active:bg-red-1000/15"
