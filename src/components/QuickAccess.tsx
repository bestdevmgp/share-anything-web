          ...
          <>
            ...
            >
              ...
              {files.map((file) => (
                <div
                  key={file.id}
                  className="flex items-center px-3 py-2.5 bg-gray-100 dark:bg-white/5 rounded-lg hover:bg-gray-200/70 dark:hover:bg-white/10 transition-colors"
                  onClick={(e) => e.stopPropagation()}
                >
                  <div
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <button
                      ...
                      className="p-1.5 rounded-lg transition-colors text-gray-400 dark:text-[#666666] hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-500/20"
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg transition-colors text-gray-400 dark:text-[#666666] hover:text-red-500 dark:hover:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/20"
