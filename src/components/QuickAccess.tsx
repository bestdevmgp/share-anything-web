                ...
                >
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg transition-colors text-muted-foreground/50 can-hover:hover:text-red-600 dark:can-hover:hover:text-[#f25f5f] can-hover:hover:bg-red-50 dark:can-hover:hover:bg-red-500/10 active:text-red-600 dark:active:text-[#f25f5f] active:bg-red-50 dark:active:bg-red-500/10"
