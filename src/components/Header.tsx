              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem
                    ...
                    className="cursor-pointer px-4 py-2 text-sm text-red-600 dark:text-red-500 font-medium can-hover:hover:bg-red-100 dark:can-hover:hover:bg-red-500/20 focus:bg-red-100 dark:focus:bg-red-500/20 focus:text-red-600 dark:focus:text-red-500 active:bg-red-100 dark:active:bg-red-500/20 active:text-red-600 dark:active:text-red-500"
                  >
                    {t('header.logout')}
                  </DropdownMenuItem>
                </DropdownMenuContent>
