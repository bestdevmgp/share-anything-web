...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-card dark:bg-background/80 dark:backdrop-blur-xl shadow-sm dark:shadow-none dark:border-b dark:border-border sticky top-0 z-50">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem
                    ...
                    className="cursor-pointer px-4 py-2 text-sm text-red-600 dark:text-red-400 font-medium focus:bg-red-50 dark:focus:bg-red-500/10 focus:text-red-600 dark:focus:text-red-400"
                  >
                    {t('header.logout')}
                  </DropdownMenuItem>
                </DropdownMenuContent>
