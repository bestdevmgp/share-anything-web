...
export const NaverLogo: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24">
    <path fill="white" d="M16.273 12.845L7.376 0H0v24h7.726V11.156L16.624 24H24V0h-7.727v12.845z" />
  </svg>
);

export const KakaoLogo: React.FC<{ className?: string }> = ({ className = 'w-[21px] h-[21px]' }) => (
  <svg className={className} viewBox="0 0 24 24">
...
export const AppleLogo: React.FC<{ className?: string }> = ({ className = 'w-[21px] h-[21px]' }) => (
...
export const providerLogoMap: Record<string, React.FC<{ className?: string }>> = {
  google: GoogleLogo,
  naver: NaverLogo,
  kakao: KakaoLogo,
  apple: AppleLogo,
