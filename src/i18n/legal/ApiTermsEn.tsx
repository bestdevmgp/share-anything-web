...
const ApiTermsEn: React.FC = () => (
    <div className="space-y-8 text-gray-700 dark:text-[#888888]">
        ...
        <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
                <li>For standard uploads, the maximum size of any single file is <strong>3GB</strong>. P2P secure transfers are not subject to this limit. Exceeding the limit returns HTTP <code className="bg-gray-100 dark:bg-white/10 px-1 py-0.5 rounded text-sm font-mono">413 Payload Too Large</code> with the error code <code className="bg-gray-100 dark:bg-white/10 px-1 py-0.5 rounded text-sm font-mono">file_too_large</code>.</li>
                <li>Per API key, the sum of file sizes of all unexpired shares (shares whose share code is still live and has not been deleted) is capped at <strong>8GB</strong>. Exceeding the quota returns HTTP <code className="bg-gray-100 dark:bg-white/10 px-1 py-0.5 rounded text-sm font-mono">429 Too Many Requests</code> with the error code <code className="bg-gray-100 dark:bg-white/10 px-1 py-0.5 rounded text-sm font-mono">storage_quota_exceeded</code>. Deleting existing shares or waiting for them to expire reclaims quota. This cap applies only to files uploaded through the OpenAPI with an API key (<code className="bg-gray-100 dark:bg-white/10 px-1 py-0.5 rounded text-sm font-mono">sak_</code>); it does not apply to files uploaded with a personal token (<code className="bg-gray-100 dark:bg-white/10 px-1 py-0.5 rounded text-sm font-mono">sat_</code>).</li>
                <li>Other limits such as per-request file count are governed by the general Terms of Use.</li>
